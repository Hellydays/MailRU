...
public class MailruTest {
	...
	private String to = "sviatlana.zakharenka@gmail.com";
	private String topic = "Fixed subject";
	private String text = "Hello World! Hello Svetlana!";
	...
	public void authTest() {
		...
		mainPage.createNewEmail(to, topic, text);
